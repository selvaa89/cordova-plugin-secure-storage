...
class RSA {
    ...
    static void createKeyPair(Context ctx, String alias) throws Exception {
    ...
    static void initCipher(int cipherMode, String alias) throws Exception {
    ...
    static boolean isEntryAvailable(String alias) {
        try {
